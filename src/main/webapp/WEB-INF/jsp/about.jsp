...
<body>
    ...
    <div class="container">
      <div class="starter-template">
        <h1>About project</h1>
        <p class="lead">Academy (as extension Institute project) is a simple java web application. My purpose was creating a simplified academy management system.<br> List of technologies were applied:</p>
        <ul>
        	<li>Java SE;</li>
        	<li>Apache Tomcat;</li>
        ...
        <address>
		  <strong>Vitaliy Ivanytskyy</strong><br>
		  Odessa, Ukraine<br>
